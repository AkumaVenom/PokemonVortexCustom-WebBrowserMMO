...
<section class="pv-auth-side"><a class="pv-brand" href="<?= pv_h(pv_url('index.php')) ?>"><span class="pv-brand-mark"><img src="<?= pv_h(pv_static_file('images/items/Poke Ball.png','images/Pokeball.PNG')) ?>" alt=""></span><span class="pv-brand-copy">POKÉMON VORTEX<small>NEW TRAINER</small></span></a><h1 style="margin-top:38px">Begin your<br><span style="color:#2a75bb">adventure.</span></h1><p class="pv-subtle">Choose your trainer identity and starter. Your first Pokémon begins at level 18 with randomized IVs, nature, gender and an available ability.</p><img src="<?= pv_h(pv_static('images/frontv3.png')) ?>" alt="Battle Arena"></section>

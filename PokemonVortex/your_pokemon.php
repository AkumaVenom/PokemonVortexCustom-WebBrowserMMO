...
<?php if(!$data['rows']):?><div class="pv-empty-state"><span class="pv-brand-mark">PV</span><div><h2>No Pokémon found</h2><p>Adjust the filters or explore world maps to expand your collection.</p><a class="pv-button" href="<?=pv_h(pv_url('map_select.php'))?>">Explore World Maps</a></div></div><?php else:?>

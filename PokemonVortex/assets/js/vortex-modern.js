...
(() => {
  ...
  const strip = make('div', 'pv-command-strip pv-combat-command-strip', `
    <span class="pv-command-state">WORLD SELECT</span><a href="map_select.php?world=vortex">Vortex World</a><a href="map_select.php?world=kanto">Kanto</a><a href="map_select.php?world=johto">Johto</a><a href="map_select.php?world=hoenn">Hoenn</a><a href="map_select.php?world=unbound">Unbound</a>`);
